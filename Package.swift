...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://github.com/dfed/SafeDI/releases/download/2.0.0-alpha-18-xcode-plugin-test/SafeDITool.artifactbundle.zip",
			checksum: "69f3e49ba15125521937a1be7b5de2350998d7092350d3b98db782046d2379a9",
		),
		.executableTarget(
			name: "SafeDITool",
			dependencies: [
