...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://github.com/dfed/SafeDI/releases/download/2.0.0-alpha-17/SafeDITool.artifactbundle.zip",
			checksum: "84c4ca06ccfa3fa412de098981ec90dacd7993d99e2ec195b82355089df04d4a",
		),
		.executableTarget(
			name: "SafeDITool",
			dependencies: [
