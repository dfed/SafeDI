...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://github.com/dfed/SafeDI/releases/download/2.0.0-beta-3/SafeDITool.artifactbundle.zip",
			checksum: "04aadbe127d22a42accf688af5bd03c628b4062cf03f7e463594f5ec09bf0beb",
		),
		.executableTarget(
			name: "SafeDITool",
			dependencies: [
