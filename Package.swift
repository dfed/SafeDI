...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://github.com/dfed/SafeDI/releases/download/2.0.0-alpha-15/SafeDITool.artifactbundle.zip",
			checksum: "ff51c4dc0278a6377049d98c762cbb47b501ce92f9771d5f06a2eeebc32442de",
		),
		.executableTarget(
			name: "SafeDITool",
			dependencies: [
