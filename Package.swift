...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			...
			url: "https://github.com/dfed/SafeDI/releases/download/2.0.0-alpha-12/SafeDITool.artifactbundle.zip",
			checksum: "0e23a3196e37c6ba56db21e40cb28e7e7aee189154e882ceb0f9d118d5bee959",
		),
		.executableTarget(
			name: "SafeDITool",
			dependencies: [
